    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center text-terminal-green/60 space-y-6">
            ...
            <div className="text-center">
                <p className="text-sm font-space font-black text-white tracking-[0.3em] uppercase">SYSTEM_NODE_READY</p>
...
export function AppDisconnectedView() {
    return (
        <div className="flex-1 flex flex-col items-center justify-center text-terminal-green/60 space-y-6">
            ...
            <div className="text-center">
                <p className="text-sm font-space font-black text-white tracking-[0.2em] uppercase">SYSTEM_LINK_OFFLINE</p>
                <p className="text-[10px] font-mono text-terminal-green/30 mt-2">
                    Awaiting handshaking with physical node...
                </p>
            </div>
        </div>
    );
